...
date('the_most_sacred_heart_of_jesus', 'The Most Sacred Heart of Jesus', _, _, _, true, false, false, false).
date('the_most_holy_body_and_blood_of_christ', 'The Most Holy Body and Blood of Christ', _, _, _, true, false, false, false).
date('the_blessed_virgin_mary_on_saturday', 'The Blessed Virgin Mary on Saturday', _, _, _, false, false, true, false).
date('our_lord_jesus_christ_king_of_the_universe', 'Our Lord Jesus Christ, King of the Universe', _, _, _, true, false, false, false).
date('the_immaculate_conception_of_the_blessed_virgin_mary', 'The Immaculate Conception of the Blessed Virgin Mary', _, _, _, true, false, false, false).
date('the_holy_family_of_jesus_mary_and_joseph', 'The Holy Family of Jesus, Mary and Joseph', _, _, _, false, false, false, false).
