...
liturgical:date(ID,'Pentecost Sunday', Year, Month, Day, true, false, false, false) :-
    constants:pentecost_sunday(ID),
    pentecost_date(Year, Month, Day),
    !.

liturgical:date(ID,'The Most Holy Trinity', Year, Month, Day, true, false, false, false) :-
...
liturgical:date(ID,'The Most Holy Body and Blood of Christ', Year, Month, Day, true, false, false, false) :-
...
liturgical:date(ID,'The Most Sacred Heart of Jesus', Year, Month, Day, true, false, false, false) :-
...
liturgical:date(ID,'The Immaculate Heart of the Blessed Virgin Mary', Year, Month, Day, false, true, false, false) :-
...
liturgical:date(ID,'The Blessed Virgin Mary, Mother of the Church', Year, Month, Day, false, true, false, false) :-
...
liturgical:date(ID,'Our Lord Jesus Christ, the Eternal High Priest', Year, Month, Day, false, false, false, false) :-
